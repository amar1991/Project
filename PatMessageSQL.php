...
$query = "INSERT INTO Message (Message,MessageDatetime,PatientId,DoctorId)" .
               "VALUES ('$Message', '$DateTime', '{$_SESSION['PID']}','$DoctorId')";

// If result matched $myusername and $mypassword, table row must be 1 row
if ( !mysql_query($query,$link) ) {
         echo '<p>Insert error</p>';
		 echo '<META HTTP-EQUIV="Refresh" Content="3; URL=PatientMain.php">'; // redirect within particular second to URL patient main page
      } else {
         echo "Message sent";
